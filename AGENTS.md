...
A seção **Estrutura atual do repositório** será atualizada periodicamente nesta conversa após commits oficiais que alterem a organização do `delta-handbook`. Até que essa atualização ocorra, sempre confirme a árvore real do repositório antes de usar a seção como referência definitiva.
